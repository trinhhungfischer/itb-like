...
|---|-------|------|--------|-----|
| 001 | Core System Contracts & Deterministic Order | Logic | Ready | ADR-0006, ADR-0004 |
| 002 | Target Selection AI | Logic | Ready | ADR-0004 |
| 003 | Movement-to-Range Destination | Logic | Ready | ADR-0009 |
| 004 | Telegraph State & Environment Queries | Logic | Ready | ADR-0011, ADR-0006 |
| 005 | Resolution Execution & Range Gate | Logic | Ready | ADR-0006 |
| 006 | On-Death Effects | Integration | Ready | ADR-0007, ADR-0006 |
| 007 | Spawn Emergence | Logic | Ready | ADR-0006 |
