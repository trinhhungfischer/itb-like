...
**Criteria**: all passing — verified by the test at `tests/unit/combat-resolution/unit-lifecycle_test.ts`
**Deviations**: see `docs/tech-debt-register.md` for sprint-level advisories
**Test Evidence**: `tests/unit/combat-resolution/unit-lifecycle_test.ts` (exists, passes; suite 285/285, tsc clean, coverage 98.9%)
