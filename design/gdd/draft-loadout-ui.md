...
| **Accessibility** (Alpha tier, Not Started) | Confirmation that every control in this document is keyboard-navigable (Rule 12) and font/scale-configurable (Tuning Knobs) | — | Soft, future — Rule 12 and the scale knobs pre-satisfy the eventual Accessibility system's audit criteria rather than waiting for that system to exist |
